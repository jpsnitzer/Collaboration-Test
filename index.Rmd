...
leaflet() %>% addTiles() %>%
  addMarkers(lng = data_mn_w$x,
    ...
    icon = list(iconUrl = "https://pngimage.net/wp-content/uploads/2018/05/blue-dot-png-2.png", iconSize = c(7,7))
  ) %>%
  addMarkers(lng = data_mn_h$x,
    lat = data_mn_h$y,
    popup = paste(sep = "<br/>",paste("<b><a href='",data_mn_h$Link,"'>",sep=""),
                  data_mn_h$Victim,"</a></b>",data_mn_h$Desc),
    icon = list(iconUrl = "https://i.ya-webdesign.com/images/dot-clipart-orange.png", iconSize = c(7,7))
  ) %>%
  addMarkers(lng = data_mn_b$x,
    lat = data_mn_b$y,
    popup = paste(sep = "<br/>",paste("<b><a href='",data_mn_b$Link,"'>",sep=""),
                  data_mn_b$Victim,"</a></b>",data_mn_b$Desc),
    icon = list(iconUrl = "https://upload.wikimedia.org/wikipedia/commons/f/f1/Ski_trail_rating_symbol_red_circle.png", iconSize = c(7,7))
  )
